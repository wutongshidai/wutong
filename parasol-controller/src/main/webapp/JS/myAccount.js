...
//					location.href="http://192.168.3.124:8082/dengL.do"
	...
	$(".navigation li").click(function(){
		localStorage.setItem("site",$(this).index());
					...
					$("#myRelesa").html(html)
						$('.checkView').click(function(){
										...
										layer.open({
										  ...
										  shadeClose: true,
										  skin: 'yourclass',
										  content: "http://192.168.3.124:8082/choiceDemand.do?projectName="+title
										});
									})
								//删除发布
		...
		if($(this).index()==3){
			...
			$.ajax({
			type: "get",
			url: 'http://192.168.3.124:8082/queryExpert.do',
			async: true,
			data:{
				'id':userId
			},
	 ...
	 var id=$(this).attr('name')
		  //询问框
					layer.confirm('确认删除专家信息吗？？', {
									...
									$.ajax({
											type: "post",
												url: 'http://192.168.3.124:8082/deleteExpert.do',
												async: true,
												data:{
													'id':id
												},
