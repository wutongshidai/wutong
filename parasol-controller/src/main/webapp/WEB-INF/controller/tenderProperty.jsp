            ...
            <div class="content-1">
                <div class="left tab_menu">
                    ...
                    <ul>
                        ...
                        <li class="wuye  backblue"><a href="/tenderProperty.do"><i class="bs"></i> 物业类</a></li>
                        <li class="zaojia"><a href="/tenderCost.do"><i class="sb"></i> 造价咨询类</a></li>
                    </ul>
                    <span class="boo">
                          <i></i>
                    </span>
