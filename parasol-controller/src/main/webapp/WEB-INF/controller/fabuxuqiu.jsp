        ...
        <div class="con">
            ...
            <form  name="form" action="/needs.do" method="post" enctype="multipart/form-data">
                <div class="le"> 
                    <!--  onkeydown 为键盘事件  -->
                    <div class="zhao">
                        <label for="zhao"><i>*</i>工程名称</label><input  type="text" id="projectName" name="projectName" value=""  placeholder="不得超过50个字符" />
                    </div>
                    <div class="zhaobiao">
                        <label for="zhaobiao"><i>*</i>招标单位</label><input  type="text" id="tenderee" name="tenderee" value=""  placeholder="不得超过50个字符"/>
                    </div> 
                    <div class="gongcheng">
                        <label for="gongcheng">招标代理机构</label><input  type="text" id="tenderCompany" name="tenderCompany" value="" placeholder="不得超过50个字符" />
                    </div>
                    <div class="fanwei">
                        <label for="fanwei"><i>*</i>项目类别</label><input  type="text" id="projectType" name="projectType"　value="" placeholder="不得超过50个字符" />
                    </div>
                    <div class="gongqi">
                    ...
                    <div class="xiangmu">
                        <label for="xiangmu"><i>*</i>项目地点</label><input  type="text" id="projectLocation" name="projectLocation" placeholder="不得超过50个字符" />
                    </div>
                ...
                <div class="re">
                    <div class="zhaob">
                        <label for="zhiliang"><i>*</i>招标地址</label><input  type="text" id="tenderAddress" name="tenderAddress" placeholder="不得超过50个字符" /><input id="classification" name="classification" type="hidden" value="${classification }" />
                    </div>
                    <div class="zhaobiaoren">
                        <label for="zhiliang"><i>*</i>联系人</label>姓名<input  type="text" class="lianXren" id="contactName" name="contactName" placeholder="二到五个字" />手机号<input id="contactMobile" name="contactMobile" class="shouJhao" type="number" placeholder="有效手机号" />
                    </div>
                    <div class="xmshuom">
                        <label for="shuoM">其他项目说明 <p id="textCount">(不超过500字)</p></label>
                        <textarea class="content" type="text" id="explainl" name="explainl" placeholder="不超过500个汉字" onkeyup="words_deal()"></textarea>
                    </div>
