	...
	public final class Files_Utils_DG {
	    ...
	    public static String FilesUpload_transferTo_spring(HttpServletRequest request, MultipartFile multipartFile, String filePath) {
	        if (multipartFile != null) {
	            //get files suffix
	        	if(multipartFile.getOriginalFilename() == null || multipartFile.getOriginalFilename().length() == 0){return null;}
	        	System.out.println(multipartFile.getOriginalFilename());
	            String suffix = multipartFile.getOriginalFilename().substring(multipartFile.getOriginalFilename().lastIndexOf("."));
	            System.out.println(suffix);
	            //filePath+fileName the complex file Name
	            String absolutePath = getAndSetAbsolutePaths(multipartFile, request, filePath, suffix);
	            System.out.println(absolutePath);
	            //return relative Path
	            String relativePath = getRelativePaths(multipartFile, filePath, suffix);
	            System.out.println(relativePath);
	            
	            String relativePathss = getRelativePathss(multipartFile, filePath, suffix);
	            System.out.println(relativePathss);
	    ...
	    public static String getRelativePathss(MultipartFile multipartFile,String filePath, String suffix) {
	        return multipartFile.getOriginalFilename();//example:/files/Upload/20160912/
	    }
