...
public class GetStartedSample {
    ...
    private static String endpoint = "<endpoint, http://oss-cn-beijing.aliyuncs.com>";
    private static String accessKeyId = "<LTAIlDAz5woSGTEZ>";
    private static String accessKeySecret = "<oK6fZZLm7bAnL4fi6tFBYuWbrc4MhH>";
    private static String bucketName = "<wutongsd-zuanjia>";
